...
class SingleMHA(nn.Module):
    ...
    def __init__(
        ...
        valid_backends = {"vanilla", "sdpa", "triton_16", "triton_32"}
...
def benchmark_single_mha(
    ...
    print("4. 默认只测 Triton 16x16，以降低资源压力；使用 --include-triton-32 可增加 32x32 版本。")
    print("=" * 112)
...
def main():
    ...
    parser.add_argument("--force-sdpa-flash", action="store_true")
